...
const config: Config = {
  ...
  url: 'https://dorfentwicklung.xn--rssing-wxa.de',
  ...
  organizationName: 'roessing', // Usually your GitHub org/user name.
  projectName: 'dorfentwicklung', // Usually your repo name.
    ...
    [
      'classic',
      {
        ...
        blog: {
          ...
          editUrl:
            'https://github.com/roessing/dorfentwicklung/tree/main/',
